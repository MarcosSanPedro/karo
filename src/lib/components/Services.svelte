<script lang="ts">
	const services = [
		...
		},
		{
			...
			tittle: 'Registro de Compañías',
			subtittle:
				'Facilitamos el proceso de creación de tu negocio, ya sea como LLC o INC, brindando asesoría para elegir la estructura más adecuada.'
		},
		{
